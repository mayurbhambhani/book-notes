...
- Whenever a system is designed certain factors will present choices to its user. A choice architect is a person who is, knowingly or unknowingly, responsible for the arrangement of those choices. Depending on the how the options are structured/arranged, a lot of user behavior is influenced.
...
- Once you choose what percentage is going to go in stocks and what is going to a bank account you need to choose what stocks to buy.
- People don't generally pick stocks, they pick mutual funds which vary in terms of how risky they are and how much they charge for their services.
...
- On the average market(S&P Index fund) returns an interest of 10.4 %. The average market return in India for NSE is around 17%.
...
- But if you are thinking long term, 20 years, then it should give 10%. Side Note: what happens the year you decide to retire, the stock market goes down. I guess you will have to wait for the market to catch up. Even if you don't, the savings should be decent enough.
...
- Even if Humans think about the problem in the same way they won't be able to make the necessary calculations. Then the decisions they do make will suffer from the following flaws
  - The decisions will be unduly(to an unwarranted degree) influenced by recent market fluctuations.
  - The decision will be likely based on rules of thumbs.
- **Influence Of Recent market fluctuations:**
  - Looking at the prices frequently: Over 20 years, stocks are almost certain to go up. In the US there is no 20 year period where stocks have declined in real value or have been outperformed by bonds. If the investors are shown the evidence on risks of stocks and bonds over a long period, such as 20 years, they choose to invest all their money in stocks. See Benartzi and Thaler (1999)
  - Market timing People generally buy high and sell low.
- **Rules Of Thumb:**
  - 1/n heuristic: If presented with n options Humans will equally allocate 1/n resources on each of those options. Sometimes companies would offer plans to the employees where the choice is made easy by offering lifestyle funds(conservative, moderate, aggressive). Or they might offer plans based on ages. But when much of these funds are offered people again use the 1/n rules. The fund itself does proper allocation and after choosing a particular fund the 1/n heuristic is not required. But people get confused.
...
- **Nudges required:**
  - Default: Enrollment should be by default. And a default strategy should also be present. Participants will just have to choose between aggressive, conservative, or a moderate strategy. Another choice of default is choosing a fund that matures the year this participant is going to retire.
